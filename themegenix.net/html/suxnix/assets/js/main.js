...
function featuresImgBtnReveal() {
	var featuresImg = document.querySelector('.features-img');
	if (!featuresImg) return;
	var btn = featuresImg.querySelector('.features-img-btn');
	if (!btn) return;
	...
	featuresImg.addEventListener('animationend', function(e) {
		if (e.animationName === 'featuresRollOut') showBtn();
	});
	...
	var observer = new IntersectionObserver(function (entries) {
		entries.forEach(function (entry) {
			if (entry.isIntersecting) {
				observer.disconnect();
				setTimeout(function () {
					var style = window.getComputedStyle(featuresImg);
